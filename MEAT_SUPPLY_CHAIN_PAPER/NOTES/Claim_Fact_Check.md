...
| 3 | Has meatpacking concentration increased, decreased, or remained stable? | **Supported** (increased, commodity-specific magnitude) | Beef CR4 36% (1980) → 80% (1997) → ~82% (~2021); pork 34%→54%→66%; poultry 32%→41%→54%. Beef's rise is a documented historical outlier per USDA/ERS AER-785 itself. |
