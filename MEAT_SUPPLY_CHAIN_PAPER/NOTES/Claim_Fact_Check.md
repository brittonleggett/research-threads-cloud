...
|---|---|---|---|
| 1 | Are U.S. cattle producers receiving historically weak returns while consumers face historically high beef prices? | **Unresolved** (leaning Partially supported / Misleading without context) | 2023→2024 beef farm *share* of retail dollar rose (49.8→52.2 cents) — opposite of "increasingly squeezed" for that year; multi-decade absolute/inflation-adjusted return not yet pulled. |
| 2 | How much of the retail beef dollar goes to farmers/ranchers vs. processors/retailers, and how has that changed? | **Partially supported**, strong "misleading without context" flag | The popular "~6 cents of the food dollar" figure is real but is an *all-food* statistic (5.9→5.8 cents, 2023→2024); the beef-specific ERS Meat Price Spreads farm share is 49.8→52.2 cents, ~10x higher and rising. Conflating the two is a common, identifiable error. |
| 3 | Has meatpacking concentration increased, decreased, or remained stable? | **Supported** (increased, commodity-specific magnitude; updated 2026-09-03 with current peer-reviewed figures) | Beef CR4 36% (1980) → 80% (1997) → **85% (2019, Schaefer et al.)**; pork 34%→54%→**67% (2019)**; poultry 32%→41%→**78% (2019, up from 48% in the 1980s)**. Beef's rise is a documented historical outlier per USDA/ERS AER-785. **Correction:** poultry's 2019 figure (78%) is much higher than the project's earlier "not particularly high" characterization (based on older AER-785 data and a 54%-2021 estimate) — poultry is no longer clearly the least-concentrated of the three. |
| 4 | Are processor profit margins unusually high during periods of elevated food inflation? | **Partially supported**, strongest for the 2020 COVID shock specifically, not general inflation periods | Balagtas & Cooper (2021) and Erol & Saghaian (2022) triangulate on margin widening during the 2020 disruption; the broader 2021–2023 inflation episode not separately examined yet. |
...
| 7 | Do imports materially suppress domestic cattle prices? | **Unresolved** | No verified U.S.-specific econometric estimate located this pass (a possibly-relevant GAO report, GAO-02-246, could not be read — follow-up). Current period shows the opposite pattern of a simple suppression story. |
...
| 13 | Are similar dynamics present in pork? | **Partially supported** | Pork farm share also rose 2023→2024 (22.1→23.7 cents), paralleling beef. More of the pork price-transmission literature finds asymmetry than the newest beef study does, but findings aren't unanimous within pork either. No pork-specific COVID-margin study confirmed yet (follow-up). |
| 14 | Is there evidence processors or retailers benefit disproportionately from supply disruptions? *(concentration-fork's general/cross-period read, vs. #12's COVID-specific read)* | **Partially supported** (upgraded 2026-09-03 via Consensus.app) | White House CEA's specific 2020 company profit figures (JBS, Tyson) are still not independently verified against SEC filings. But real, independent evidence now exists for a related, arguably stronger claim: **2019 antitrust litigation alleged the four largest U.S. beef packers (Tyson, JBS, Cargill, National Beef) engaged in fed-cattle price-fixing collusion (Sherman Act §1); the case settled with no-wrongdoing statements.** A structural study (Bolotova 2021) independently finds wholesale beef pricing shifted from patterns consistent with competitive pricing (2010–2014) to patterns consistent with oligopoly/monopoly pricing during 2015–2019, with farm sector value share falling and marketing margins rising in that window. Countervailing: an event-study (Parcell & Franken 2026) using error-correction VAR on the same period finds only slight, economically unimportant change in price-adjustment speed — i.e., the *regime-level* pricing-pattern evidence and the *behavioral* price-responsiveness evidence point in different directions. Present both, not just one. |
| 15 | Are claims about "food monopolies" supported by the empirical literature, or would "highly concentrated supply chains" be more defensible terminology? | **Partially supported** toward "highly concentrated" | No sector shows single-firm monopoly in the technical sense; all show 3–4 major competing firms with CR4 well under 100%. "Oligopoly"/"concentrated"/"monopsony concern" are the technically precise terms; "monopoly" functions as political/advocacy shorthand, not a technically accurate claim — itself useful Study 1 framing-analysis material. **Update 2026-09-03:** real Sherman Act §1 collusion litigation (see Claim #14) and a peer-reviewed structural finding of an oligopoly/monopoly-consistent pricing shift in 2015–2019 (Bolotova 2021) mean "oligopoly" specifically — not just "concentrated" — has direct empirical/legal grounding for beef in that period, strengthening the case for precise IO terminology over "monopoly" without needing to invoke the looser popular term at all. |
...
- Two claims (#1, #5, #7) remain genuinely **Unresolved** and should not be
  used as settled facts in any manuscript draft.
...
## Follow-ups flagged across all four passes (not yet done)
- Pull the full USDA ERS Meat Price Spreads historical time series (1970–
  ...
  (needed for claim #1's "historically weak" framing).
- Retry access to: Schaefer et al. (peer-reviewed concentration update),
  Meat Institute rebuttal page (403 both times), GAO-02-246 (PDF extraction
  failed), Pozo/Bachmeier/Schroeder (2021) and Erol & Saghaian (2022) full
  text (both paywalled, relied on abstracts).
- Pull actual SEC 10-K/earnings-call margin data for Tyson and JBS
  (2019–2023) to properly test claim #14 rather than leaving it on an
  unverified political-source figure.
- Extract pork-specific figures from Balagtas & Cooper (2021) to confirm or
  disconfirm a pork-specific COVID-margin finding (claim #13).
- Federal Register/FSIS direct-text verification for the COOL timeline
  (currently corroborated via CRS + secondary legal summaries, not read
  directly — both sites blocked automated fetch this pass).
