...
| Four-firm processor concentration (CR4), most-cited recent figure | **85% of steer/heifer slaughter (2019, Schaefer et al. 2024, peer-reviewed FSIS plant-level data — updated 2026-09-03 via Consensus.app; supersedes the earlier 82% White House CEA estimate)**; USDA ERS AER-785 historical series shows steer/heifer CR4 at 80% and boxed-fed-beef CR4 at 83% already by 1997 | **67% of hog slaughter (2019, Schaefer et al.)**; ERS AER-785 shows hog CR4 at 54% by 1997, so continued rise since | **78% of broiler processing (2019, Schaefer et al.), up from 48% in the 1980s — CORRECTION: this is substantially higher than the White House CEA's 54% (2021) estimate and than this table's prior "not particularly high" characterization.** Roughly half of poultry's CR4 rise since 1991 is attributable to M&A consolidation specifically (counterfactual: 60% CR4 absent that consolidation) rather than organic growth. |
| Trajectory since 1980s | Sharpest, most dramatic rise of any of the three — described by USDA ERS itself (AER-785) as "unique," with no other 5-digit Census product class showing as dramatic an increase in any 15-year window (steer/heifer CR4: 36% in 1980 → 80% in 1997 → 85% by 2019 per Schaefer et al.). | Large rise, roughly a generation behind beef: hog slaughter CR4 rose from 34% (1980) to 54% (1997) per ERS, to 67% by 2019 per Schaefer et al. | **Revised 2026-09-03 — not comparatively modest after all.** Chicken slaughter CR4 41–42% by 1987 per ERS, but continued rising to **78% by 2019** per Schaefer et al. (up from 48% in the 1980s) — roughly half of that post-1991 rise is attributable to M&A consolidation specifically (counterfactual without it: 60%). ERS's older "not particularly high" characterization (based on 1990s data) no longer describes the current level; poultry concentration by 2019 is closer to pork's than to a modest reading. |
