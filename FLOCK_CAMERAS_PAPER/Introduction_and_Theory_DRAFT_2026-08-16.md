...
tool (haveibeenflocked.com). **Update, 2026-09-01:** the industry-tracking figure has been updated
and given a firmer source. The Institute for Justice maintains a running, dated tally of ALPR
misuse cases (its "IJ Database of ALPR Abuse"; the page itself is bot-blocked to direct fetch, a
403, same pattern as SAGE/ScienceDirect) — a secondary outlet's direct quote of that tally,
fetched directly rather than only WebSearch-summarized, put it at **24 cases as of mid-July 2026**,
specifically in the officers-tracking-romantic-partners category (narrower than "similar cases"
generally), with the majority occurring since 2024. This both confirms the pattern is real and
supersedes the earlier "at least 21" figure, which appears to have been a stale or
imprecisely-scoped count; because IJ describes it explicitly as a running tally, any figure cited
here should be dated (as of mid-July 2026) rather than presented as a fixed total, and a
before-submission check for a more current count is recommended. This
would, if the broader misuse category is confirmed at a similar scale, convert this from an
anecdotal pattern into a documented
...
8. **2026-08-27 update:** the Nhan & Helfers article's actual title and DOI were located and added
   ...
   draft's item #5.
9. **2026-09-01 update — literature citation verification pass, WebFetch/Crossref confirmed
   ...
   working alternative path. The Institute for Justice ALPR-misuse running tally was also updated
   (24 cases as of mid-July 2026, sourced via a direct fetch of a secondary article quoting IJ,
   not WebSearch-summary) superseding the earlier unsourced "at least 21" figure. No locked theme,
   hypothesis, design element, or Britton-reserved design call was touched; the vignette-wording
   and confound concerns raised in the 2026-08-27 face-validity review were left entirely as-is —
   not re-decided. Full detail, including what remains unverified (the Police Journal article's
   exact disclosure-statement wording; Tyler/Tyler & Huo/Nissenbaum's book text itself, not just
   their existence) in `notes/2026-09-01-literature-citation-verification-pass.md`.
